...
library(readxl)
mydata<-read_excel("C:\\Users\\arun\\Desktop\\DATA SCIENCE FOLDER\\Clustering\\University_Clustering.xlsx") ## use read.csv for csv files
...
cor(data[-1])
# Model Building#
pcaObj<-princomp(data[-1], cor = TRUE, scores = TRUE, covmat = NULL)
